...
public class TweetController {
    ...
    public String getTweetForm(Tweet tweet) {
        return "newTweet";
    }

    @PostMapping(value = "/tweets")
    public String submitTweetForm(@Valid Tweet tweet, BindingResult bindingResult, Model model,@RequestParam(name="messagePar") String messagePar) {
        User user = userService.getLoggedInUser();
        if (!bindingResult.hasErrors()) {
            tweet.setUser(user);
          //  tweet.setMessage(tweetService.shortenLink(message));
